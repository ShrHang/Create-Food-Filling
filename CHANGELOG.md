...
## 1.5.1 26-7-18
- Fixed a bug in 1.20.1 while filling glass bottles with potion fluids, which caused the glass bottles be filled as a potioned food instead of a potion item.
