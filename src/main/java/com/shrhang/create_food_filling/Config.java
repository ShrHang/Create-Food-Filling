...
public class Config {
    ...
    public static class Common {
        ...
        public final ForgeConfigSpec.BooleanValue isAnimalsFoodFilled;
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            isAnimalsFoodFilled = builder
                    .comment("When enabled, items in the \"create_food_filling:animals_food\" tag are considered fillable.")
    ...
    public static class Server {
        public final ForgeConfigSpec.BooleanValue isPreFilterEvent;
        public final ForgeConfigSpec.BooleanValue enableFeedAnimalFoodEffects;
        public final ForgeConfigSpec.BooleanValue enableFoxFoodEffects;
        public final ForgeConfigSpec.BooleanValue enablePandaFoodEffects;
        public final ForgeConfigSpec.BooleanValue enableVillagerFoodEffects;

        Server(ForgeConfigSpec.Builder builder) {
            isPreFilterEvent = builder
                    .comment("When enabled, mixins check basic conditions before posting eating-related events.")
