...
public class Config {
    ...
    public static class Common {
        ...
        public final ModConfigSpec.BooleanValue prefilterEvent;
        ...
        Common(ModConfigSpec.Builder builder) {
            ...
            prefilterEvent = builder
                    .comment("When enabled, mixins will pre-filter before posting Event.")
                    .define("prefilterEvent", true);
